package boletin_1_variables_y_condicionales15;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(
                "Ejercício 15 - Pedir el dia, mes y año de una fecha e indicar si la fecha es correcta. Suponiendo todos los meses de 30 dias. \n");
        ...
        switch (error) {
            ...
            case "edmy":
                System.out.println(
                        ConsoleColors.error("INVALID VALUES - DIA: " + dia + " MES: " + mes + " ANO: " + ano + "\n"));
                break;
            default:
